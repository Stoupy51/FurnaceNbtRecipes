...
execute in minecraft:overworld positioned -30000000 14 1610 run function furnace_nbt_recipes:v1.3/technical/call_recipes
...
# Otherwise, continue
execute if score #reset furnace_nbt_recipes.data matches 0 if score #found furnace_nbt_recipes.data matches 1 run function furnace_nbt_recipes:v1.3/technical/cook
