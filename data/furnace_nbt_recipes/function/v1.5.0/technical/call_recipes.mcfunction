...
execute if score #found furnace_nbt_recipes.data matches 0 if score #nbt_smelting.major load.status matches 1.. run function furnace_nbt_recipes:v1.5.0/nbt_smelting_compatibility/call_recipes
