...
#> furnace_nbt_recipes:v1.7.0/advancements/check_for_furnaces/try_place_marker
#
# @within	furnace_nbt_recipes:v1.7.0/advancements/check_for_furnaces/look_layer
#
