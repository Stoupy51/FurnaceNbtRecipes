...
#> furnace_nbt_recipes:v1.9.0/load/enumerate
#
...
execute if score #furnace_nbt_recipes.major load.status matches 1 if score #furnace_nbt_recipes.minor load.status matches 9 unless score #furnace_nbt_recipes.patch load.status matches 0.. run scoreboard players set #furnace_nbt_recipes.patch load.status 0
