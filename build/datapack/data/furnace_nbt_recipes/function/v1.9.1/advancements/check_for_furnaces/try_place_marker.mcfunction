...
#> furnace_nbt_recipes:v1.9.1/advancements/check_for_furnaces/try_place_marker
#
# @within	furnace_nbt_recipes:v1.9.1/advancements/check_for_furnaces/look_layer
#
