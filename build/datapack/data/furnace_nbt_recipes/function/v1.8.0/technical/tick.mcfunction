...
#> furnace_nbt_recipes:v1.8.0/technical/tick
#
# @within	furnace_nbt_recipes:v1.8.0/loop
#
...
execute if score #destroy furnace_nbt_recipes.data matches 0 unless data block ~ ~ ~ {CookTime:0s} run function furnace_nbt_recipes:v1.8.0/technical/main
