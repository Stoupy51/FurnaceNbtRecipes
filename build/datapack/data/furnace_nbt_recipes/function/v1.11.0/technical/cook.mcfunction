...
#> furnace_nbt_recipes:v1.11.0/technical/cook
#
# @executed	as @e[type=marker,tag=furnace_nbt_recipes.furnace] & at @s
#
# @within	furnace_nbt_recipes:v1.11.0/technical/clock
#			furnace_nbt_recipes:v1.11.0/technical/main
#

# Take the library output and consume one input item
execute in minecraft:overworld run function furnace_nbt_recipes:v1.11.0/technical/shulker_manipulation
...
execute if score #found furnace_nbt_recipes matches 0 run function furnace_nbt_recipes:v1.11.0/technical/default_xp
...
scoreboard players set @s furnace_nbt_recipes.partial 0
