...
#> furnace_nbt_recipes:v1.11.0/technical/same_output
#
...
function furnace_nbt_recipes:v1.11.0/technical/same_output_check with storage furnace_nbt_recipes:main check
