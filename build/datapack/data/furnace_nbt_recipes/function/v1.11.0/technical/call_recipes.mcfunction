...
#> furnace_nbt_recipes:v1.11.0/technical/call_recipes
#
# @executed	in minecraft:overworld & positioned -30000000 14 1610
#
# @within	furnace_nbt_recipes:v1.11.0/technical/main [ in minecraft:overworld & positioned -30000000 14 1610 ]
#
...
execute if score #found furnace_nbt_recipes.data matches 0 if score #nbt_smelting.major load.status matches 1.. run function furnace_nbt_recipes:v1.11.0/nbt_smelting_compatibility/call_recipes
