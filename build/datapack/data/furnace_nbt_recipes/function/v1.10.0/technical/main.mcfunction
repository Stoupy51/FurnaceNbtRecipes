...
#> furnace_nbt_recipes:v1.10.0/technical/main
#
# @executed	as @e[type=marker,tag=furnace_nbt_recipes.furnace] & at @s
#
# @within	furnace_nbt_recipes:v1.10.0/technical/tick
#
...
execute in minecraft:overworld positioned -30000000 14 1610 run function furnace_nbt_recipes:v1.10.0/technical/call_recipes
...
# Otherwise, continue
execute if score #reset furnace_nbt_recipes.data matches 0 if score #found furnace_nbt_recipes.data matches 1 run function furnace_nbt_recipes:v1.10.0/technical/cook
...
execute if score #reset furnace_nbt_recipes.data matches 0 if score #found furnace_nbt_recipes.data matches 1 if score @s furnace_nbt_recipes.stall_time matches 100.. run function furnace_nbt_recipes:v1.10.0/technical/cook
