...
execute if score #destroy furnace_nbt_recipes.data matches 0 unless data block ~ ~ ~ {cooking_time_spent:0s} run function furnace_nbt_recipes:v1.10.0/technical/main
