...
#> furnace_nbt_recipes:v1.10.2/load/enumerate
#
...
execute if score #furnace_nbt_recipes.major load.status matches 1 if score #furnace_nbt_recipes.minor load.status matches 10 unless score #furnace_nbt_recipes.patch load.status matches 2.. run scoreboard players set #furnace_nbt_recipes.patch load.status 2
