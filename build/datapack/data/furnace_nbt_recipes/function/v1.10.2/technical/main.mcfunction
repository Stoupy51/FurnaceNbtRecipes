...
execute in minecraft:overworld positioned -30000000 14 1610 run function furnace_nbt_recipes:v1.10.2/technical/call_recipes
...
execute if score #found furnace_nbt_recipes.data matches 1 if data storage furnace_nbt_recipes:main furnace.Items[{Slot:2b}] run function furnace_nbt_recipes:v1.10.2/technical/same_output
...
# Otherwise, continue
execute if score #reset furnace_nbt_recipes.data matches 0 if score #found furnace_nbt_recipes.data matches 1 if score #total_time furnace_nbt_recipes.data matches 1.. run function furnace_nbt_recipes:v1.10.2/technical/clock
...
execute if score #reset furnace_nbt_recipes.data matches 0 if score #found furnace_nbt_recipes.data matches 1 if score @s furnace_nbt_recipes.stall_time matches 5 if data block ~ ~ ~ {lit_time_remaining:0} if data block ~ ~ ~ Items[{Slot:1b}] if data block ~ ~ ~ Items[{Slot:2b}] run function furnace_nbt_recipes:v1.10.2/technical/ignite

# Force smelting if stalled for too long (100 ticks)
execute if score #reset furnace_nbt_recipes.data matches 0 if score #found furnace_nbt_recipes.data matches 1 if score @s furnace_nbt_recipes.stall_time matches 100.. run function furnace_nbt_recipes:v1.10.2/technical/cook
